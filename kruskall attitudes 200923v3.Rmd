---
title: "kruskall attitudes 200923"
author: "Ian Philips"
date: "`r Sys.Date()`"
...
opiniondf <- function(opinion_var = "Q19_2021_c_lickert_safety",
  ...
  require(rlang)
    ...
    #testing
 # opinion_var = "Q45_2021_e"
 # raw_var = "Q45_2021_e"
 # segment_var = "segment21"
 # segs = c("Resident ebike owner 21","Visitor ebike owner 21","Hirer 21","Resident non ebike 21", "Visitor non ebike 21")
...
## "After Covid, transport and tourism should be greener"
...
raw.var21 = "Q45_2021_a"
opinion.var21  = "Q45_2021_a"
raw.var20 = "Q43a" 
opinion.var20  = "Q43a"
ct.opinion.name  = "opinion"
plot.title = "After Covid, transport and tourism should be greener(cross section)"

#check <- dat_20 %>% dplyr::select(segment,Q43a) 
...
```{r}
a21f <- opiniondf(opinion_var = raw.var21,
                  raw_var = raw.var21,segment_var = "segment21",
                  segs = c("Hirer 21","Resident ebike owner 21",
                            "Resident non ebike 21","Visitor ebike owner 21","Visitor non ebike 21"),
                  
                  #segs = c("Hirer 21","Resident ebike owner 21",
                  #         "Visitor ebike owner 21"),
                  data_to_use = dat_21 %>% filter(Q47_2021 == "female")
                  )
...
a20f <- opiniondf(opinion_var = raw.var20,
                  raw_var = raw.var20,segment_var = "segment",
                   segs = c("Hirer 20","Resident ebike owner 20", "Resident non ebike 20", "Visitor ebike owner 20","Visitor non ebike 20"),
...
a21m <- opiniondf(opinion_var = raw.var21,
                  raw_var = raw.var21,segment_var = "segment21",
                   segs = c("Hirer 21","Resident ebike owner 21",
                            "Resident non ebike 21","Visitor ebike owner 21","Visitor non ebike 21"),
                  #segs = c("Hirer 21","Resident ebike owner 21",
...
a20m <- opiniondf(opinion_var = raw.var20,
                  raw_var = raw.var20,segment_var = "segment",
                   segs = c("Hirer 20","Resident ebike owner 20", "Resident non ebike 20","Visitor ebike owner 20","Visitor non ebike 20"),
                  #segs = c("Hirer 20","Visitor ebike owner 20"),
...
comp2yr <- compare_segs_across_years_lookup(df = a,
                                 to_compare = c("female_hirer","male_hirer","female_visitor_ebike",
                                                "male_visitor_ebike",
                                                "male_res_owner","male_res_non_ebike",
                                                "female_res_owner","female_res_non_ebike"))
...
```{r}
plot.title = "After Covid, transport and tourism should be greener\n(panel)"
```
...
## "The Lake District national park would be more beautiful if\n more people travelled by bike or e-bike\n and fewer people travelled by car/van"
...
raw.var21 = "Q45_2021_b"
opinion.var21  = "Q45_2021_b"
raw.var20 = "Q43b"
opinion.var20  = "Q43b"
ct.opinion.name  = "opinion"
plot.title = "The Lake District national park would be more beautiful if\n more people travelled by bike or e-bike\n and fewer people travelled by car/van (cross section)"
...
```{r}
plot.title = "The Lake District national park would be more beautiful if\n more people travelled by bike or e-bike\n and fewer people travelled by car/van (panel)"
```
...
```{r}
######################    e-bikes are a good way to replace some car journeys                  ################
```
...
raw.var21 = "Q45_2021_d"
opinion.var21  = "Q45_2021_d"
raw.var20 = "Q43d"
opinion.var20  = "Q43d"
ct.opinion.name  = "opinion"
plot.title = "e-bikes are a good way to replace some car journeys (cross section)"
...
```{r}
plot.title = "e-bikes are a good way to replace some car journeys (panel)"
```
...
# Personal aspiration around potential behaviour change



##  I would like to travel by car less in the Lake District

```{r}
#name stuff

raw.var21 = "Q45_2021_e"
opinion.var21  = "Q45_2021_e"
raw.var20 = "Q43e"
opinion.var20  = "Q43e"
ct.opinion.name  = "opinion"
plot.title = "I would like to travel by car less in the Lake District (cross section)"


#check <- dat_21 %>% dplyr::select(segment21,Q45_2021_e,Q47_2021) 
...
```{r}
plot.title = "I would like to travel by car less in the Lake District (panel)"
```
...
```{r}
################# would consider using PT to visit ############################
```



##  I would consider visiting the Lake District without a car if public transport were improved between my home ant the Lake District

```{r}
#name stuff

raw.var21 = "Q45_2021_f"
opinion.var21  = "Q45_2021_f"
raw.var20 = "Q43f"
opinion.var20  = "Q43f"
ct.opinion.name  = "opinion"
plot.title = "I would consider visiting the Lake District without a car\n if public transport were improved\n between my home and the Lake District (cross section)"
...
a21f <- opiniondf(opinion_var = raw.var21,
                  ...
                  #           "Resident non ebike 21","Visitor ebike owner 21","Visitor non ebike 21"),
                  segs = c("Hirer 21",
                            "Visitor ebike owner 21","Visitor non ebike 21"),
...
a20f <- opiniondf(opinion_var = raw.var20,
                  raw_var = raw.var20,segment_var = "segment",
                   # segs = c("Hirer 20","Resident ebike owner 20", "Resident non ebike 20", "Visitor ebike owner 20","Visitor non ebike 20"),
                   segs = c("Hirer 20", "Visitor ebike owner 20","Visitor non ebike 20"),
                  data_to_use =  dat_20 %>% filter(Q45 == "female")
...
a21m <- opiniondf(opinion_var = raw.var21,
                  ...
                  #  segs = c("Hirer 21","Resident ebike owner 21",
                  #           "Resident non ebike 21","Visitor ebike owner 21","Visitor non ebike 21"),
                segs = c("Hirer 21", "Visitor ebike owner 21","Visitor non ebike 21"),
                      data_to_use = dat_21 %>% filter(Q47_2021 == "male")
...
```{r}
plot.title = "I would consider visiting the Lake District without a car\n if public transport were improved\n between my home and the Lake District (panel)"
```
...
```{r}
############### restrict access more beautiful ################ 
```
...
##  Restricting tourist cars and vans in some Lakeland valleys (e.g. Langdale, Borrowdale) would make the Lake District more beautiful


```{r}
#name stuff

raw.var21 = "Q45_2021_c"
opinion.var21  = "Q45_2021_c"
raw.var20 = "Q43c"
opinion.var20  = "Q43c"
ct.opinion.name  = "opinion"
plot.title = "Restricting tourist cars and vans\n in some Lakeland valleys (e.g. Langdale, Borrowdale)\n would make the Lake District more beautiful
 (cross section)"
...
a20m <- opiniondf(opinion_var = raw.var20,
                  raw_var = raw.var20,segment_var = "segment",
                  segs = 
                    c("Hirer 20","Resident ebike owner 20", "Resident non ebike 20","Visitor ebike owner 20","Visitor non ebike 20"),
                  #segs = c("Hirer 20", "Visitor ebike owner 20","Visitor non ebike 20"),
                  data_to_use  = dat_20 %>% filter(Q45 == "male")
)
...
```{r}
plot.title = "Restricting tourist cars and vans\n in some Lakeland valleys (e.g. Langdale, Borrowdale)\n would make the Lake District more beautiful (panel)"
```
...
```{r}
############## Restricting tourist cars and vans in some Lakeland valleys (e.g. Langdale, Borrowdale) would be good for the tourism industry #####
```
...
raw.var21 = "Q45_2021_g"
opinion.var21  = "Q45_2021_g"
raw.var20 = "Q43i"
opinion.var20  = "Q43i"
ct.opinion.name  = "opinion"
plot.title = "Restricting tourist cars and vans in some Lakeland valleys\n (e.g. Langdale, Borrowdale)\n would be good for the tourism industry "
...
a21f <- opiniondf(opinion_var = raw.var21,
                  raw_var = raw.var21,segment_var = "segment21",
                  segs = c("Resident ebike owner 21",
                           "Resident non ebike 21"),
                  #segs = c("Hirer 21",
                  #          "Visitor ebike owner 21","Visitor non ebike 21"),
...
a20f <- opiniondf(opinion_var = raw.var20,
                  raw_var = raw.var20,segment_var = "segment",
                    segs = c("Resident ebike owner 20",
                           "Resident non ebike 20"),
                   #segs = c("Hirer 20", "Visitor ebike owner 20","Visitor non ebike 20"),
                  data_to_use =  dat_20 %>% filter(Q45 == "female")
...
comp2yr <- compare_segs_across_years_lookup(df = a,
                                 to_compare = c("male_res_owner","male_res_non_ebike",
                                                "female_res_owner","female_res_non_ebike"))
...
```{r}
plot.title = "Restricting tourist cars and vans in some Lakeland valleys (e.g. Langdale, Borrowdale) would make the Lake District more beautiful (panel)"
```
...
```{r}
###################### car restraint non tourism business ################### 
```


## "Restricting tourist cars and vans in some Lakeland valleys\n (e.g. Langdale, Borrowdale)\n would be good for non-tourist businesses (cross section)"


```{r}
#name stuff

raw.var21 = "Q45_2021_h"
opinion.var21  = "Q45_2021_h"
raw.var20 = "Q43j"
opinion.var20  = "Q43j"
ct.opinion.name  = "opinion"
plot.title = "Restricting tourist cars and vans in some Lakeland valleys\n (e.g. Langdale, Borrowdale)\n would be good for non-tourist businesses (cross section)"
...
```{r}
plot.title = "Restricting tourist cars and vans in some Lakeland valleys\n (e.g. Langdale, Borrowdale)\n would be good for non-tourist businesses (panel)"
```
